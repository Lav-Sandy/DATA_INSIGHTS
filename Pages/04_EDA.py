...
st.write('<p style="font-size:100%">&nbsp 4. Get descriptive analysis - To decide which feature needs SCALING</p>', unsafe_allow_html=True)
st.write('<p style="font-size:100%">&nbsp 5. Check imbalance or distribution of target variable:</p>', unsafe_allow_html=True)
...
st.write('<p style="font-size:100%">&nbsp 8. Get outlier analysis with box plots. This is calculated using IQR (Interquartile Ranges) method.</p>', unsafe_allow_html=True)
...
if use_defo:
    dataset = r'C:\Users\91897\Data\height-weight.csv'
